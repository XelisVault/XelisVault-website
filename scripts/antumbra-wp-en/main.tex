...
\hypersetup{
  ...
  pdfkeywords={ANTUMBRA, ATU, blockchain, privacy, reputation, BlockDAG, RandomX, CryptoNote}
}
...
\begin{center}
  ...
  {\small Version 1.1, September 2026}
\end{center}
...
regulators. ANTUMBRA occupies that empty square. It couples a CPU-mined
...
which the heaviest is time itself, which cannot be bought. The money supply
...
it. This document is the public reference specification for the network.
\end{abstract}
