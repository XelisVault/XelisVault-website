      ...
      <AnimatePresence>
        {showBackToTop && (
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 w-11 h-11 rounded-full bg-vault text-white flex items-center justify-center shadow-lg hover:bg-vault/85 transition-all hover:shadow-[0_0_24px_-4px_var(--vault)]"
